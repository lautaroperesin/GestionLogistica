...
namespace LogisticaBackend.Migrations
{
    ...
    [Migration("20251202015144_AgregaRelacionEnvioUsuario")]
    partial class AgregaRelacionEnvioUsuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LogisticaBackend.Models.Envio", b =>
                {
                    ...
                    b.Property<int?>("ConductorIdConductor")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConductorIdConductor");
            ...
            modelBuilder.Entity("LogisticaBackend.Models.Envio", b =>
                {
                    b.HasOne("LogisticaBackend.Models.Conductor", null)
                        .WithMany("Envios")
                        .HasForeignKey("ConductorIdConductor");
                    ...
                    b.HasOne("GestionLogisticaBackend.Models.Usuario", "Usuario")
                        .WithMany("Envios")
